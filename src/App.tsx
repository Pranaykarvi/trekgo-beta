...
<div className="absolute top-4 right-20">
  <a href="./src/login.html" className="bg-green-600 text-white py-2 px-6 rounded-md hover:bg-green-700 transition-transform transform hover:scale-105 shadow-lg mr-4">
    Login
  </a>
  <a href="./src/signup.html" className="bg-green-600 text-white py-2 px-6 rounded-md hover:bg-green-700 transition-transform transform hover:scale-105 shadow-lg">
    Sign Up
  </a>
</div>
